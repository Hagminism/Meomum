...
sealed class CommunityWriteAction with _$CommunityWriteAction {
  ...
  const factory CommunityWriteAction.setLocation(CommunityPlace? place) = SetLocation;
  const factory CommunityWriteAction.changeTitle(String title) = ChangeTitle;
  const factory CommunityWriteAction.changeContent(String content) = ChangeContent;
