...
class HomePostDetailComments extends StatelessWidget {
  const HomePostDetailComments({super.key});

  @override
  Widget build(BuildContext context) {
    return const Column(
      children: [
        _HomePostDetailComment(
          nickname: '닉네임',
          time: '1분 전',
          location: '죽도동',
...
class _HomePostDetailComment extends StatelessWidget {
...
class _HomePostDetailCommentAction extends StatelessWidget {
  final IconData icon;
  final int count;
  final Color color;

  const _HomePostDetailCommentAction({
    required this.icon,
    required this.count,
    required this.color,
  });
