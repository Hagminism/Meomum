...
class CommunityPostDetailFooter extends StatelessWidget {
  final CommunityPost post;
  final void Function() onLike;
  final void Function() onShare;

  const CommunityPostDetailFooter({
    super.key,
    required this.post,
...
class _CommunityPostDetailAction extends StatelessWidget {
  final IconData icon;
  final int count;
  final Color color;
  final void Function() onTap;

  const _CommunityPostDetailAction({
    required this.icon,
    required this.count,
